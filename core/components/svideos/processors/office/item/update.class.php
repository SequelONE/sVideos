...
class sVideosOfficeItemUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('svideos_item_err_ns');
        }
...
return 'sVideosOfficeItemUpdateProcessor';
